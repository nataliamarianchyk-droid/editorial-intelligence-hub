...
export const authors: Record<AuthorKey, Author> = {
  natalia: {
    ...
    bio: "Marketing Specialist at NM Insight - a Berlin-based marketing professional focused on the infrastructure between acquisition and revenue.",
...
export const insights: Insight[] = [
...

  {
    ...
    titleItalicSub: "The handoff between marketing and sales is where most pipeline dies.",
    dek: "The marketing-to-sales handoff is where most B2B pipeline dies. The fix is structural - lifecycle stages, SLAs, routing and a feedback loop in your CRM.",
    category: "growth-systems",
    authorKey: "editorial",
    author: "NM Editorial Team",
    date: "July 2026",
    read: "11 min",
    issue: "Issue 03",
    href: "/growth-systems/your-crm-is-the-real-marketing-tool",
    status: "published",
  },
  {
    slug: "icp-precision",
