...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Editorial insights from the operational side of marketing - acquisition, attribution, content and the systems that connect them." },
      { name: "author", content: "NM Insight" },
      { property: "og:title", content: "NM Insight - Marketing Insights" },
      { property: "og:description", content: "Editorial insights from the operational side of marketing - acquisition, attribution, content and the systems that connect them." },
          ...
          "@graph": [
            {
              ...
              description:
                "Editorial insights on marketing - the operational side of acquisition, attribution, content and the systems that connect them.",
              inLanguage: "en",
            ...
            },
            {
              ...
              description:
                "Berlin-based marketing blog publishing monthly editorial insights for operators building the infrastructure between marketing and revenue.",
              sameAs: [
